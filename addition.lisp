...
(define-model addition
  ...
  (add-dm
    ...
    (n00 ISA NUMBER VALUE "0" ONES "0" TENS "0"))
    (n01 ISA NUMBER VALUE "1" ONES "1" TENS "0"))
    (n02 ISA NUMBER VALUE "2" ONES "2" TENS "0"))
    (n03 ISA NUMBER VALUE "3" ONES "3" TENS "0"))
    (n04 ISA NUMBER VALUE "4" ONES "4" TENS "0"))
    (n05 ISA NUMBER VALUE "5" ONES "5" TENS "0"))
    (n06 ISA NUMBER VALUE "6" ONES "6" TENS "0"))
    (n07 ISA NUMBER VALUE "7" ONES "7" TENS "0"))
    (n08 ISA NUMBER VALUE "8" ONES "8" TENS "0"))
    (n09 ISA NUMBER VALUE "9" ONES "9" TENS "0"))
